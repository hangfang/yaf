...
CREATE TABLE `wechat_receive_message` (
  ...
  `MsgId` int(64) unsigned NOT NULL DEFAULT '0' COMMENT '消息id，64位整型',
  `MsgType` varchar(10) NOT NULL DEFAULT '' COMMENT 'MsgType,消息类型,link,location,小视频为shortvideo,视频为video,语音为voice,image,text，event',
