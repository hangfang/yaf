...
class DM_Http_HttpHelper
{
	...
	public static function curl($url, $httpMethod = "GET", $postFields = null,$headers = null)
	{
		...
		$httpResponse = new DM_Http_HttpResponse();
		$httpResponse->setBody(curl_exec($ch));
		$httpResponse->setStatus(curl_getinfo($ch, CURLINFO_HTTP_CODE));
		if (curl_errno($ch))
		{
			throw new DM_Exception_ClientException("Speicified endpoint or uri is not valid.", "SDK.ServerUnreachable");
		}
		curl_close($ch);
		return $httpResponse;
	}
