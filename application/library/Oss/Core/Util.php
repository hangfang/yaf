...
class Oss_Core_Util
{
    ...
    public static function validateOptions($options)
    {
        ...
        if ($options != NULL && !is_array($options)) {
            throw new Oss_Core_Exception ($options . ':' . 'option must be array');
        }
    }
    ...
    {
        if (empty($content)) {
            throw new Oss_Core_Exception("http body content is invalid");
        }
    }
     ...
     * @return void
     */
    public static function throwOss_Core_ExceptionWithMessageIfEmpty($name, $errMsg)
    {
        if (empty($name)) {
            throw new Oss_Core_Exception($errMsg);
        }
    }
...
BBB;
    ...
    public static function decodeKey($key, $encoding)
    {
        ...
        if ($encoding == "url") {
            ...
            throw new Oss_Core_Exception("Unrecognized encoding type: " . $encoding);
        }
    }
}
