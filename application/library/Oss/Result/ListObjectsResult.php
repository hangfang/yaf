 ...
 * @package OSS\Result
 */
class Oss_Result_ListObjectsResult extends Oss_Result_Result
{
    /**
    ...
    protected function parseDataFromResponse()
    {
        ...
        return new Oss_Model_ObjectListInfo($bucketName, $prefix, $marker, $nextMarker, $maxKeys, $delimiter, $isTruncated, $objectList, $prefixList);
    }
    ...
    private function parseObjectList($xml, $encodingType)
    {
        ...
        if (isset($xml->Contents)) {
            foreach ($xml->Contents as $content) {
                ...
                $retList[] = new Oss_Model_ObjectInfo($key, $lastModified, $eTag, $type, $size, $storageClass);
            }
        }
        return $retList;
    }
    ...
    private function parsePrefixList($xml, $encodingType)
    {
        ...
        if (isset($xml->CommonPrefixes)) {
            foreach ($xml->CommonPrefixes as $commonPrefix) {
                ...
                $retList[] = new Oss_Model_PrefixInfo($prefix);
            }
        }
        return $retList;
    }
