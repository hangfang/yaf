...
class Oss_Client
{
     ...
     * @throws Oss_Core_Exception
     */
    public function __construct($accessKeyId, $accessKeySecret, $endpoint, $isCName = false, $securityToken = NULL)
    {
        if (empty($accessKeyId)) {
            throw new Oss_Core_Exception("access key id is empty");
        }
        if (empty($accessKeySecret)) {
            throw new Oss_Core_Exception("access key secret is empty");
        }
        if (empty($endpoint)) {
            throw new Oss_Core_Exception("endpoint is empty");
        }
    ...
    public function listBuckets($options = NULL)
    {
        if ($this->hostType === self::OSS_HOST_TYPE_CNAME) {
            throw new Oss_Core_Exception("operation is not permitted with CName host");
        }
        ...
        $result = new Oss_Result_ListBucketsResult($response);
    ...
    public function createBucket($bucket, $acl = self::OSS_ACL_TYPE_PRIVATE, $options = NULL)
    {
        ...
        $response = $this->auth($options);
        $result = new Oss_Result_PutSetDeleteResult($response);
        return $result->getData();
    }
    ...
    public function doesBucketExist($bucket)
    {
        ...
        $response = $this->auth($options);
        $result = new Oss_Result_ExistResult($response);
        return $result->getData();
    }
    ...
    public function getBucketAcl($bucket, $options = NULL)
    {
        ...
        $options[self::OSS_SUB_RESOURCE] = 'acl';
        $response = $this->auth($options);
        $result = new Oss_Result_AclResult($response);
        return $result->getData();
    }
    ...
    public function getBucketLogging($bucket, $options = NULL)
    {
        ...
        $response = $this->auth($options);
        $result = new Oss_Result_GetLoggingResult($response);
        return $result->getData();
    }
    ...
    public function putBucketLogging($bucket, $targetBucket, $targetPrefix, $options = NULL)
    {
        ...
        $loggingConfig = new Oss_Result_GetLoggingResult($targetBucket, $targetPrefix);
    ...
    public function getBucketWebsite($bucket, $options = NULL)
    {
        ...
        $options[self::OSS_SUB_RESOURCE] = 'website';
        $response = $this->auth($options);
        $result = new Oss_Result_GetWebsiteResult($response);
        return $result->getData();
    }
    ...
    public function getBucketCors($bucket, $options = NULL)
    {
        ...
        $options[self::OSS_SUB_RESOURCE] = 'cors';
        $response = $this->auth($options);
        $result = new Oss_Result_GetCorsResult($response, __FUNCTION__);
        return $result->getData();
    }
    ...
    public function addBucketCname($bucket, $cname, $options = NULL)
    {
        ...
        $options[self::OSS_CONTENT_TYPE] = 'application/xml';
        $cnameConfig = new Oss_Model_CnameConfig();
    ...
    public function getBucketCname($bucket, $options = NULL)
    {
        ...
        $options[self::OSS_SUB_RESOURCE] = 'cname';
        $response = $this->auth($options);
        $result = new Oss_Result_GetCnameResult($response);
        return $result->getData();
    }
    ...
    public function optionsObject($bucket, $object, $origin, $request_method, $request_headers, $options = NULL)
    {
        ...
        $response = $this->auth($options);
        $result = new Oss_Result_HeaderResult($response);
        return $result->getData();
    }
    ...
    public function getBucketLifecycle($bucket, $options = NULL)
    {
        ...
        $options[self::OSS_SUB_RESOURCE] = 'lifecycle';
        $response = $this->auth($options);
        $result = new Oss_Result_GetLifecycleResult($response);
        return $result->getData();
    }
    ...
    public function getBucketReferer($bucket, $options = NULL)
    {
        ...
        $options[self::OSS_SUB_RESOURCE] = 'referer';
        $response = $this->auth($options);
        $result = new Oss_Result_GetRefererResult($response);
        return $result->getData();
    }
    ...
    public function listObjects($bucket, $options = NULL)
    {
        ...
        $response = $this->auth($options);
        $result = new Oss_Result_ListObjectsResult($response);
        return $result->getData();
    }
    ...
    public function putObject($bucket, $object, $content, $options = NULL)
    {
        ...
        Oss_Core_Util::validateContent($content);
    ...
    {
        $this->precheckCommon($bucket, $object, $options);
        Oss_Core_Util::throwOss_Core_ExceptionWithMessageIfEmpty($file, "file path is invalid");
        $file = Oss_Core_Util::encodePath($file);
        if (!file_exists($file)) {
            throw new Oss_Core_Exception($file . " file does not exist");
        }
    ...
    public function deleteObjects($bucket, $objects, $options = null)
    {
        ...
        if (!is_array($objects) || !$objects) {
            throw new Oss_Core_Exception('objects must be array');
        }
        $options[self::OSS_METHOD] = self::OSS_HTTP_POST;
        $options[self::OSS_BUCKET] = $bucket;
        $options[self::OSS_OBJECT] = '/';
        ...
        $xmlBody = Oss_Core_Util::createDeleteObjectsXmlBody($objects, $quiet);
    ...
    public function getObject($bucket, $object, $options = NULL)
    {
        ...
        $response = $this->auth($options);
        $result = new Oss_Result_BodyResult($response);
        return $result->getData();
    }
    ...
    public function initiateMultipartUpload($bucket, $object, $options = NULL)
    {
        ...
        $response = $this->auth($options);
        $result = new Oss_Result_InitiateMultipartUploadResult($response);
        return $result->getData();
    }
    ...
    public function uploadPart($bucket, $object, $uploadId, $options = null)
    {
        ...
        $response = $this->auth($options);
        $result = new Oss_Result_UploadPartResult($response);
        return $result->getData();
    }
    ...
    public function listParts($bucket, $object, $uploadId, $options = null)
    {
        ...
        $response = $this->auth($options);
        $result = new Oss_Result_ListPartsResult($response);
        return $result->getData();
    }
    ...
    public function completeMultipartUpload($bucket, $object, $uploadId, $listParts, $options = NULL)
    {
        ...
        if (!is_array($listParts)) {
            throw new Oss_Core_Exception("listParts must be array type");
        }
        $options[self::OSS_CONTENT] = Oss_Core_Util::createCompleteMultipartUploadXmlBody($listParts);
        $response = $this->auth($options);
        $result = new Oss_Result_PutSetDeleteResult($response);
        return $result->getData();
    }
    ...
    public function listMultipartUploads($bucket, $options = null)
    {
        ...
        $response = $this->auth($options);
        $result = new Oss_Result_ListMultipartUploadResult($response);
        return $result->getData();
    }
    ...
    public function multiuploadFile($bucket, $object, $file, $options = null)
    {
        ...
        if (empty($file)) {
            throw new Oss_Core_Exception("parameter invalid, file is empty");
        }
        $uploadFile = Oss_Core_Util::encodePath($file);
        if (!isset($options[self::OSS_CONTENT_TYPE])) {
        ...
        if ($upload_position === false || !isset($upload_file_size) || $upload_file_size === false || $upload_file_size < 0) {
            throw new Oss_Core_Exception('The size of `fileUpload` cannot be determined in ' . __FUNCTION__ . '().');
        }
        // 处理partSize
        ...
        foreach ($pieces as $i => $piece) {
            ...
            if ($is_check_md5) {
                $content_md5 = Oss_Core_Util::getMd5SumForFile($uploadFile, $from_pos, $to_pos);
    ...
    public function uploadDir($bucket, $prefix, $localDirectory, $exclude = '.|..|.svn|.git', $recursive = false, $checkMd5 = true)
    {
        ...
        if (empty($bucket)) throw new Oss_Core_Exception("parameter error, bucket is empty");
        if (!is_string($prefix)) throw new Oss_Core_Exception("parameter error, prefix is not string");
        if (empty($localDirectory)) throw new Oss_Core_Exception("parameter error, localDirectory is empty");
        $directory = $localDirectory;
        $directory = Oss_Core_Util::encodePath($directory);
        //判断是否目录
        if (!is_dir($directory)) {
            throw new Oss_Core_Exception('parameter error: ' . $directory . ' is not a directory, please check it');
        }
        //read directory
        $file_list_array = Oss_Core_Util::readDir($directory, $exclude, $recursive);
        if (!$file_list_array) {
            throw new Oss_Core_Exception($directory . ' is empty...');
        }
    ...
    public function signUrl($bucket, $object, $timeout = 60, $method = self::OSS_HTTP_GET, $options = NULL)
    {
        ...
        if (self::OSS_HTTP_GET !== $method && self::OSS_HTTP_PUT !== $method) {
            throw new Oss_Core_Exception("method is invalid");
        }
        $options[self::OSS_BUCKET] = $bucket;
        $options[self::OSS_OBJECT] = $object;
    ...
    {
        Oss_Core_Util::validateOptions($options);
        if (!$options) {
            $options = array();
        }
    }
    ...
    {
        Oss_Core_Util::throwOss_Core_ExceptionWithMessageIfEmpty($bucket, $errMsg);
    }
    ...
    {
        Oss_Core_Util::throwOss_Core_ExceptionWithMessageIfEmpty($object, "object name is empty");
    }
    ...
    {
        if (!isset($options[$param])) {
            throw new Oss_Core_Exception('The `' . $param . '` options is required in ' . $funcName . '().');
        }
    }
    ...
    {
        if (!is_null($file)) {
            $type = Oss_Core_MimeTypes::getMimetype($file);
            if (!is_null($type)) {
                return $type;
            }
        }

        $type = Oss_Core_MimeTypes::getMimetype($object);
        if (!is_null($type)) {
            return $type;
        }
     ...
     * @return ResponseCore
     * @throws Oss_Core_Exception
     * @throws Oss_Http_RequestCoreException
     */
    private function auth($options)
    {
        ...
        $signable_query_string = Oss_Core_Util::toQueryString($signable_query_string_params);
        ...
        //创建请求
        $request = new Oss_Http_RequestCore($this->requestUrl);
        ...
        } catch (Oss_Http_RequestCoreException $e) {
            throw(new Oss_Core_Exception('RequestCoreException: ' . $e->getMessage()));
        }
        ...
        $data = new Oss_Http_ResponseCore($response_header, $request->get_response_body(), $request->get_response_code());
    ...
    {
        if (!(('/' == $options[self::OSS_OBJECT]) && ('' == $options[self::OSS_BUCKET]) && ('GET' == $options[self::OSS_METHOD])) && !Oss_Core_Util::validateBucket($options[self::OSS_BUCKET])) {
            throw new Oss_Core_Exception('"' . $options[self::OSS_BUCKET] . '"' . 'bucket name is invalid');
        }
    }
    ...
    private function authPrecheckObject($options)
    {
        ...
        if (isset($options[self::OSS_OBJECT]) && !Oss_Core_Util::validateObject($options[self::OSS_OBJECT])) {
            throw new Oss_Core_Exception('"' . $options[self::OSS_OBJECT] . '"' . ' object name is invalid');
        }
    }
    ...
    private function authPrecheckObjectEncoding(&$options)
    {
        ...
        try {
            if (Oss_Core_Util::isGb2312($options[self::OSS_OBJECT])) {
                $options[self::OSS_OBJECT] = iconv('GB2312', "UTF-8//IGNORE", $options[self::OSS_OBJECT]);
            } elseif (Oss_Core_Util::checkChar($options[self::OSS_OBJECT], true)) {
    ...
    private function authPrecheckAcl($options)
    {
        if (isset($options[self::OSS_HEADERS][self::OSS_ACL]) && !empty($options[self::OSS_HEADERS][self::OSS_ACL])) {
            if (!in_array(strtolower($options[self::OSS_HEADERS][self::OSS_ACL]), self::$OSS_ACL_TYPES)) {
                throw new Oss_Core_Exception($options[self::OSS_HEADERS][self::OSS_ACL] . ':' . 'acl is invalid(private,public-read,public-read-write)');
            }
        }
    }
    ...
    private function generateQueryString($options)
    {
        ...
        return Oss_Core_Util::toQueryString($queryStringParams);
    }
    ...
    private function checkEndpoint($endpoint, $isCName)
    {
        ...
        } elseif (Oss_Core_Util::isIPFormat($ret_endpoint)) {
            ...
            if ($extensions) {
                foreach ($enabled_extension as $item) {
                    if (!in_array($item, $extensions)) {
                        throw new Oss_Core_Exception("Extension {" . $item . "} is not installed or not enabled, please check your php env.");
                    }
                }
            } else {
                throw new Oss_Core_Exception("function get_loaded_extensions not found.");
            }
        } else {
            throw new Oss_Core_Exception('Function get_loaded_extensions has been disabled, please check php config.');
        }
    }
    ...
    const OSS_HEADERS = Oss_Core_Util::OSS_HEADERS;
    ...
    const OSS_MAX_OBJECT_GROUP_VALUE = Oss_Core_Util::OSS_MAX_OBJECT_GROUP_VALUE;
    const OSS_MAX_PART_SIZE = Oss_Core_Util::OSS_MAX_PART_SIZE;
    const OSS_MID_PART_SIZE = Oss_Core_Util::OSS_MID_PART_SIZE;
    const OSS_MIN_PART_SIZE = Oss_Core_Util::OSS_MIN_PART_SIZE;
    ...
    const OSS_CONTENT = Oss_Core_Util::OSS_CONTENT;
    const OSS_BODY = 'body';
    const OSS_LENGTH = Oss_Core_Util::OSS_LENGTH;
    const OSS_HOST = 'Host';
    const OSS_DATE = 'Date';
