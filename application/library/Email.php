...
class Email {
	...
	public function __construct(array $config = array())
	{
        ...
        $config = $config['application']['email'];
	...
	protected function _prep_q_encoding($str)
	{
		...
		if ($this->charset === 'UTF-8')
		{
			...
			elseif (extension_loaded('mbstring') === TRUE)
			{
		...
		{
			$chr = ($this->charset === 'UTF-8' && extension_loaded('iconv') === TRUE)
	...
	protected function _set_error_message($msg, $val = '')
	{
		...
		if (sscanf($msg, 'lang:%s', $line) !== 1 OR !isset($error[$line]))
		{
			$this->_debug_msg[] = str_replace('%s', $val, $msg).'<br />';
		}
		else
		{
			$this->_debug_msg[] = str_replace('%s', $val, $error[$line]['errmsg']).'<br />';
		}
	}
