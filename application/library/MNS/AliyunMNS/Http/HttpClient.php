...
class HttpClient
{
        ...
        $accessKey, $securityToken = NULL, Config $config = NULL)
    {
        ...
        $this->client = new \MNS\GuzzleHttp\Client([
            'base_uri' => $endPoint,
            'defaults' => [
                'headers' => [
                    'Host' => $endPoint
