...
use MNS\AliyunMNS\Requests\SetQueueAttributeRequest;
use MNS\AliyunMNS\Responses\SetQueueAttributeResponse;
use MNS\AliyunMNS\Requests\GetQueueAttributeRequest;
use MNS\AliyunMNS\Responses\GetQueueAttributeResponse;
use MNS\AliyunMNS\Requests\SendMessageRequest;
use MNS\AliyunMNS\Responses\SendMessageResponse;
use MNS\AliyunMNS\Requests\PeekMessageRequest;
use MNS\AliyunMNS\Responses\PeekMessageResponse;
use MNS\AliyunMNS\Requests\ReceiveMessageRequest;
use MNS\AliyunMNS\Responses\ReceiveMessageResponse;
use MNS\AliyunMNS\Requests\DeleteMessageRequest;
use MNS\AliyunMNS\Responses\DeleteMessageResponse;
use MNS\AliyunMNS\Requests\ChangeMessageVisibilityRequest;
use MNS\AliyunMNS\Responses\ChangeMessageVisibilityResponse;
use MNS\AliyunMNS\Requests\BatchSendMessageRequest;
use MNS\AliyunMNS\Responses\BatchSendMessageResponse;
use MNS\AliyunMNS\Requests\BatchReceiveMessageRequest;
use MNS\AliyunMNS\Responses\BatchReceiveMessageResponse;
use MNS\AliyunMNS\Requests\BatchPeekMessageRequest;
use MNS\AliyunMNS\Responses\BatchPeekMessageResponse;
use MNS\AliyunMNS\Requests\BatchDeleteMessageRequest;
use MNS\AliyunMNS\Responses\BatchDeleteMessageResponse;
