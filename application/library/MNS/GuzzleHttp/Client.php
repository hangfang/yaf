...
use MNS\GuzzleHttp\Cookie\CookieJar;
use MNS\GuzzleHttp\Promise;
use MNS\GuzzleHttp\Psr7;
use MNS\Psr\Http\Message\UriInterface;
...
class Client implements ClientInterface
{
     ...
     *   MNS\GuzzleHttp\Promise\PromiseInterface that is fulfilled with a
     ...
     *
     * @see \MNS\GuzzleHttp\RequestOptions for a list of available request options.
     */
